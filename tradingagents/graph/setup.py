...
class GraphSetup:
    ...
    def setup_graph(
        ...
        if "short" in selected_analysts:
            analyst_nodes["short"] = create_short_interest_analyst(
                self.quick_thinking_llm
            )
            delete_nodes["short"] = create_msg_delete()
            tool_nodes["short"] = self.tool_nodes["short"]
